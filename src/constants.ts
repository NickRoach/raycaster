...
export const raycastHeight = window.innerHeight - margin * 2
export const raycastWidth = window.innerWidth - margin * 2
...
export const topDarkness = 1
export const bottomDarkness = 0.75
export const eastDarken = 0.95
export const westDarken = 0.9
export const northDarken = 0.85
export const southDarken = 0.8
